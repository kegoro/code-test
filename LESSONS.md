...
## 2.9 ⭐ 2026-06-14 — 鑽豹三刀流（第5章）：進場時機 + 資金管理

### 2.9.1 核心概念：盤整後第一支帶量長紅K = 主力進場成本價

- 長期盤整後，第一次出現**帶量長紅K棒**，判斷是大戶（主力）開始發動
- 理由：不可能是散戶前一天約好同一天湧入買進，大成交量 = 機構進場
- 這支紅K的價位 ≈ 主力的成本區，主力「有動機保護這個價位」
- **正確進場**：這根紅K**當天或隔天盤整期**進場（不是追漲）
- 買在主力成本附近 = 被保護的相對低檔，**不是買最低點**

**案例：上詮（3363）**
- 2023/12 進入盤整 → 2024/2/1 拉出第一支帶量長紅K
- 進場時距前一波整理區漲幅約 10%（= 可承擔的最大跌回風險）
- 搭配基本面：AI 伺服器換代需要光通零組件 → 題材支撐
...
| 停損設定 | 跌 **10%** 就出場 |
| 最低目標報酬 | 停損額 × **1.5 倍以上** |
| 數學含義 | 停損 10 元 → 目標至少 15 元；停損 10% → 目標至少 15% |
| 總資金 100 萬時 | 單檔最多 15 萬，跌 10% = 1.5 萬虧損（總資金 1.5%） |

### 2.9.3 投資基本公式：**報酬率 × 勝率 = 期望值**
...
- 反例（必輸組合）：
  ...
  - 賠率 30%、每次虧 30% → 累積 -9%
  - 合計：**-2%**（長期必輸）
- 正確思路：**目標報酬 ≥ 停損額 1.5 倍**，然後再求勝率；順序不能顛倒
- 「有賺就好」心態 = 主動壓低自己的報酬率 = 必須靠極高勝率補救（散戶做不到）

### 2.9.4 萬點後的安全進場邏輯

- 台股達萬點後，優質公司不缺，關鍵是**在哪個價格買**
- 目標：買在主力大舉進場的時候（主力成本）= 被保護的相對低價
- **不是買最低點**，是買「主力已經開始建倉的那個位置」

### 2.9.5 對缺貨雷達系統的啟示

| 鑽豹原則 | 缺貨雷達現況 | 缺口 |
|---------|------------|------|
| 帶量長紅K進場 | ❌ 雷達只看月營收 YoY | 月末訊號出來後，需另看K線確認帶量突破再進場 |
| 停損 10% | — 倉位管理，不在掃描系統範疇 | 使用者自行執行 |
| 目標 = 停損 × 1.5 | — 同上 | — |
| 買主力成本，非最低 | ✅ Phase 1 找月營收加速（基本面先發動） | 技術面確認尚未自動化 |
